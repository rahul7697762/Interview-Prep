...
async function GET() {
    try {
        const tokenResponse = await fetch("https://api.vapi.ai/token/web", {
            method: "POST",
            headers: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json(data); // { token: "...", expiresAt: "..." }
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/index.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$8d3f3c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/actions/data:8d3f3c [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
const Agent = ({ userName, userId, interviewId, feedbackId, type, questions })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const handleGenerateFeedback = async (messages)=>{
            ...
            const { success, feedbackId: id } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$8d3f3c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createFeedback"])({
    ...
    const handleCall = async ()=>{
        ...
        try {
            const vapiInstance = await getVapiInstance(); // Fetch token and init Vapi
            if (type === "generate") {
                await vapiInstance.start("e9940cd0-836a-4244-b6f3-e99a9a833b0b", {
                    variableValues: {
                        username: userName,
                        userid: userId
                    }
    ...
    const getVapiInstance = async ()=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vapi"].isInitialized()) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vapi"].init({
                token: ("TURBOPACK compile-time value", "4363a255-109d-4bf2-8be7-8496ca864848"),
                userId: userId,
                userName: userName,
                interviewer: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["interviewer"]
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vapi"];
    };
...
//# sourceMappingURL=_249e5e84._.js.map